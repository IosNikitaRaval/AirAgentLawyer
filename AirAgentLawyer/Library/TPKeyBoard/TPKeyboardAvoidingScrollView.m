...
-(BOOL)textFieldShouldBeginEditing:(UITextField *)textField {
    ...
    if ([self delegate] != nil) {
        ...
        NSLog(@"begin editing");
        return [[self delegate] willTextFieldBeginEditing:textField];
    }
    return YES;
}
...
-(void)textFieldDidEndEditing:(UITextField *)textField {
    ...
    if ([self delegate] != nil) {
        ...
        NSLog(@"end editing");
        [[self delegate] didTextFieldEditingFinish:textField];
    }
}
...
-(BOOL)textViewShouldBeginEditing:(UITextView *)textView {
    ...
    if ([self delegate] != nil) {
        ...
        NSLog(@"begin editing");
        return [[self delegate] willTextFieldBeginEditing:textView];
    }
    return YES;
}
...
-(void)textViewDidEndEditing:(UITextView *)textView {
    ...
    if ([self delegate] != nil) {
        ...
        NSLog(@"end editing");
        [[self delegate] didTextFieldEditingFinish:textView];
    }
}
...
//        NSLog(@"end editing");
        return [[self delegate] shouldChangeTextViewText:textView range:range text:text];
    }
    return YES;
}
